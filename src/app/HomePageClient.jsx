...
import splitOnion from "@/assets/split-onion.webp";
...
const onionRange = [
  { slug: "?category=white", label: "White Onion", icon: "Onion", isQuery: true },
  { slug: "?category=red", label: "Red Onion", icon: "Onion", isQuery: true },
  { slug: "?category=pink", label: "Pink Onion", icon: "Onion", isQuery: true },
];
const garlicRange = [
  { slug: "garlic-flakes", label: "Garlic Flakes", icon: "Garlic" },
  { slug: "garlic-powder", label: "Garlic Powder", icon: "Powder" },
  { slug: "garlic-chopped", label: "Garlic Chopped", icon: "Minced" },
  { slug: "garlic-minced", label: "Garlic Minced", icon: "Minced" },
...
const RangeItem = ({ slug, label, icon, isQuery }) => {
  return (
    <li>
      <Link
        href={isQuery ? `/products${slug}` : `/products/${slug}`}
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-hero lg:min-h-screen lg:flex lg:items-center">
        {/* Cream/beige background on the LEFT 50% - made transparent for seamless gradient */}
        ...
        <div className="absolute inset-y-0 right-0 w-full lg:w-1/2 z-0">
          ...
          <div className="absolute inset-y-0 left-0 w-40 bg-gradient-to-r from-[#FEF1D5] to-transparent hidden lg:block" />
